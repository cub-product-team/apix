                            ...
                            <aside className="w-1/3 max-w-sm flex flex-col bg-neutral-900/50 p-6 border-r border-white/10">
                                ...
                                <div className="flex-grow overflow-y-auto space-y-6 pr-2 -mr-4">
                                    <div className="border-b border-white/10 pb-6 space-y-4">
                                        ...
                                        <div><label htmlFor="cover-aspect-ratio" className="block text-sm font-medium text-neutral-300 mb-2">{t('appCover_aspectRatio')}</label><div className="dropdown"><div id="cover-aspect-ratio" className="form-input !p-2 theme-dropdown-panel" tabIndex={0} role="combobox" aria-expanded="false" aria-haspopup="listbox">{COVER_ASPECT_RATIOS.map(ratio => <option key={ratio} value={ratio}>{ratio}</option>)}</div></div></div>
                                        <div>
